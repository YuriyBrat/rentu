...
const StyledWrapperStack = styled(Stack)(({ theme }) => ({
  ...
  height: "100%",
  ":before": {
    content: "url(/assets/home/Image.png)",
    right: 0,
    top: "76px",
    zIndex: 1,
    position: "absolute",
  ...
  return (
    <StyledWrapperStack>
      <LayoutContainer>
        ...
        >
          <Grid item xs={12} md={6} pt={{ xs: "30px", md: "180px" }}>
            <Box display={{ xs: "block", sm: "none", md: "none" }} mb={10}>
              <Image src="/assets/home/Image-mobile.png" />
            </Box>
            <StyledRoundBox>
              <Box
                component="img"
                src="/assets/home/round-text.svg"
                width="100%"
              />
            </StyledRoundBox>
          ...
          <Grid item xs={12} md={6} position="relative"></Grid>
        </Grid>
      </LayoutContainer>
    </StyledWrapperStack>
  );
