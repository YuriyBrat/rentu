            ...
            <div className="row gy-4">
              ...
              >
                <div className="member">
                  ...
                  <img
                    src="/land1/images/team/team-1.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <h4>Jhone Bi</h4>
              ...
              >
                <div className="member">
                  ...
                  <img
                    src="/land1/images/team/team-3.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <h4>Andrio Willi</h4>
              ...
              >
                <div className="member">
                  ...
                  <img
                    src="/land1/images/team/team-4.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <h4>Afa Jonson</h4>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        <ul>
                          <li>1. Вибрати усі подібні об'кти кокретної ніші: клас будинку, стан ремонту, популяризація району</li>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header">
                      ...
                      >
                        ...
                        Реклама на яких ресурсах дає найбільший потік клієтів?
                      </button>
                    </h3>
                    <div
                      id="faq-content-2"
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        Із радістю розмістимо Ваше оголошення на нашому сайті, додаково надамо персоналізований дизайн
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        штат працівників, маркетинговий відділ із фахівцями, які щоденно здйснюють рекламу,
                        представницьк офіси, веб-ресурси, принаймні професійний сайт та гідну репутацію на ринку.
                        Для цього варто перевірити агентство у сертифікованих асоціацій на ознаки шахрайста та недобросовісності.
                        АФНУ, ЛОР інші.

                        Ми - системна компанія із багаторічним досвідом та кваліфікованими працівниками та із вдячністю
                        проявимо відповідні зусилля для продажу Вашої нерухомсті задля збереження проявленої довіри.
                      </div>
                    </div>
                  </div>
                  {/* # Faq item*/}
