...
// import { StyledGradienthBox } from "@/estatein/pages/Properties";
...
import Services from "@/estatein/_moc_data/Services";
import RepeatingSection, {
  StyledBox,
  StyledIconBox,
} from "@/estatein/components/Services-page/RepeatingSection";
import StarIcon from "@/estatein/components/icons/StarIcon";
import useWindowSize from "@/estatein/hooks/useWindowSize";


// also is used in Properties Page
...
const StyledAbstractBox = styled(Box)(({ theme }) => ({
  padding: "50px",
  background: "url(/esta/assets/services/Abstract.png)",
...
const InformedData = [
  {
    icon: "/esta/assets/services/icon1.png",
  ...
  {
    icon: "/esta/assets/services/icon9.png",
  ...
  {
    icon: "/esta/assets/services/icon10.png",
  ...
  {
    icon: "/esta/assets/services/icon8.png",
