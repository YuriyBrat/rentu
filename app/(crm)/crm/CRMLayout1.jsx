   ...
   return (
      <Box
         sx={{
            ...
            color: TEXT,
            background: `
          radial-gradient(circle at 18% 18%, rgba(139,92,246,0.10), transparent 45%),
          radial-gradient(circle at 82% 75%, rgba(139,92,246,0.06), transparent 42%),
          ${BG_DARK}
        `,
            ...
            >
               <Typography
                  ...
                  sx={{
                     ...
                     letterSpacing: 0.2,
                     color: ACCENT,
                     textShadow: `0 0 14px rgba(139,92,246,0.40)`,
                     userSelect: 'none',
                     ...
                     <Tooltip key={item.path} title={!open ? item.label : ''} placement="right">
                        <ListItemButton
                           ...
                           sx={{
                              ...
                              py: 1.05,
                              borderRadius: 2,
                              border: `1px solid ${active ? 'rgba(139,92,246,0.30)' : 'transparent'}`,
                              position: 'relative',
                              overflow: 'hidden',
                              backgroundColor: active ? 'rgba(139,92,246,0.10)' : 'transparent',
                              boxShadow: active ? `0 0 0 1px rgba(139,92,246,0.10), 0 12px 28px rgba(0,0,0,0.35)` : 'none',
                              ...
                              '&::before': {
                                 ...
                                 borderRadius: 10,
                                 background: active
                                    ? `linear-gradient(180deg, ${ACCENT}, rgba(139,92,246,0.18))`
                                    : 'transparent',
                                 boxShadow: active ? `0 0 14px rgba(139,92,246,0.55)` : 'none',
                                 opacity: active ? 1 : 0,
                              ...
                              '&:hover': {
                                 ...
                                 boxShadow: `0 0 0 1px rgba(139,92,246,0.10), 0 10px 25px rgba(0,0,0,0.30)`,
                              },
