...
const PropertiesView = () => {
   ...
   const keyData = [
      "Якісний свіжий сучасний ремонт",
      "Балкон із панорамою парку та природи",
                        ...
                        >
                           ...
                           <StyledLocationBox>
                              ...
                              <Typography variant="body1" color="text.secondary">
                                 {propview?.location?.city + ' ' + propview?.location?.street}
                              </Typography>
                           </StyledLocationBox>
                        </Stack>
                           ...
                           <StyledBorderStack direction="column" gap={1}>
                              ...
                              >
                                 ...
                                 >
                                    ...
                                    <Typography variant="subtitle2" color="text.secondary">
                                       {propview?.floor} / {propview?.floors}
                                    </Typography>
                                 </Stack>
                                 ...
                                 >
                                    ...
                                    <Typography variant="subtitle2" color="text.secondary">
                                       {propview?.square_tot} / {propview?.square_liv} / {propview?.square_kit}
                                    </Typography>
                                 </Stack>
                              </Stack>
                           </StyledBorderStack>
                     ...
                     <Stack id="review" py={1}>
                        ...
                        >
                           <Grid container spacing={2}>
                              ...
                              <Grid item xs={12} md={4} lg={4}>
                                 <TextField type='datetime-local' fullWidth label="Дата і час" variant='outlined'
                                    value={() => Date.now()} />
                              </Grid>
