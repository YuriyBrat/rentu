...
import ContactForm from "@/estatein/components/ContactForm";
import Office from "@/estatein/components/Office";
import ExploreContact from "@/estatein/components/Explore-Contact";
...
const contactData = [
  {
    icon: "/esta/assets/mail.svg",
    txt: "info@estatein.com",
  },
  {
    icon: "/esta/assets/phone.svg",
    txt: "+1 (123) 456-7890",
  },
  {
    icon: "/esta/assets/location.svg",
    txt: "Main Headquarters",
  },
  {
    icon: "/esta/assets/socil.svg",
    txt: "",
    link: [
      {
        socilName: "Instagram",
