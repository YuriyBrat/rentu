            ...
            <div className={"flex flex-col md:flex-row justify-around"}>
               ...
               >
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                     ...
                     {property.rates.nightly ? (<div>$ {property.rates.nightly.toLocaleString()}</div>)
               ...
               >
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                     {property.rates.weekly ? (<div>$ {property.rates.weekly.toLocaleString()}</div>)
                        : (<FaTimes className='text-red-700' />)}
                  </div>
               </div>
               <div className={"flex items-center justify-center mb-4 pb-4 md:pb-0"}>
                  ...
                  <div className="text-2xl font-bold text-blue-500">
                     {property.rates.monthly ? (<div>$ {property.rates.monthly.toLocaleString()}</div>)
                        : (<FaTimes className='text-red-700' />)}
                  </div>
               </div>
            </div>
